...
_DRE_CORR = {
    'mm': {
        '1': {'rec_doc_sai': 9728.39, 'rec_svc': 8921.40,
              ...
              'laudo_custo': 3081.60,
              'salarios': 83976.32,
              'associacoes': 250.00, 'publicidade': 14493.90,
        ...
        '2': {'rec_doc_sai': 14241.12, 'rec_svc': 4670.00,
              ...
              'taxas_transf_ent': 4452.24, 'laudo_custo': 2545.0,
        ...
        '3': {'rec_doc_sai': 22639.05, 'rec_svc': 8380.00,
              ...
              'despachante_ent': 2300.0, 'ipva': 20108.70,
        ...
        '5': {'rec_svc': 5814.00,
              ...
              'custo_prep_entrega': 45061.72, 'frete': 80.00,
              'despachante_ent': 700.00, 'ipva': 18907.18,
              'taxas_transf_ent': 3613.00, 'laudo_custo': 2160.90,
              'desc_pagar': 10595.14, 'juros_rec': 370.02,
              'desc_receber': 1000.00, 'juros_pagar2': 145.38},
        '6': {'rec_doc_sai': 4534.90, 'rec_svc': 7000.00, 'fotos': 3500.00, 'rec_diversas': 18147.16,
              'merch_bruta_sw': 2447678.00,
              'custo_compra_sw': 2132930.46,
              'custo_prep_entrega': 42582.32, 'frete': 0.00,
              'despachante_ent': 1100.00, 'ipva': 17533.71,
              'taxas_transf_ent': 2052.00, 'baixa_gravame': 900.00,
              'comunicado_venda': 89.90, 'multas_nao_abat': 303.16,
              'garantia_custo': 4650.00, 'laudo_custo': 1552.00,
        ...
        '7': {
              ...
              'desc_sw': 30388.10, 'desc_at': 36080.00,
        ...
        '8': {
              ...
              'dev_fin': 0.00,
              # custos: API incompleta pra Data Competência 08/2026
              'custo_prep_entrega': 58603.33, 'frete': 0.00,
              'despachante_ent': 3660.00, 'ipva': 20027.60,
              'taxas_transf_ent': 3242.00, 'laudo_custo': 1132.80,
    ...
    'bk': {
        ...
        '3': {'taxas_transf_ent': 593.07,
              'custo_prep_entrega': 5882.64, 'despachante_ent': 200.00, 'ipva': 10482.08,
        ...
        '6': {'rec_doc_sai': 794.73, 'rec_diversas': 46.22,
              'ipva': 1613.29, 'taxas_transf_ent': 208.00, 'laudo_custo': 839.30,
              'custo_prep_entrega': 16487.11},
        '7': {'merch_bruta_sw': 919700.00, 'merch_bruta_at': 107000.00,
        ...
        '8': {'desc_pagar': 290.26, 'juros_rec': 0.01, 'desc_receber': 12.00,
              'juros_pagar2': 132.40,
              'salarios': 24836.04, 'copa': 725.96, 'cartorio': 232.98, 'agua': 216.32,
...
_DRE_CORR_2025 = {
    'mm':   {
        ...
        '2': {
            ...
            'venda_svc': 33281.86,
            # CUSTOS
            'laudo_custo': 5960.20, 'custo_prep_entrega': 53494.77, 'ipva': 10151.10,
            # DESPESAS OPERACIONAIS
            'comissao_venda': 17806.90, 'despachante_sai': 3947.29,
            'desp_pessoal_var': 825.38, 'desp_adm_dem': 2235.37, 'contabil': 78847.51,
            'juridico': 3829.50, 'emprestimos': 24059.54, 'agua': 208.00,
            # RES. FINANCEIRO
            'desc_pagar': 11836.76, 'desc_receber': 1935.00, 'juros_rec': 267.79,
            'juros_pagar2': 0.00, 'juros_pagar': 108.41,
        },
        '3': {
            # RECEITAS
            'venda_svc': 19362.03,
            # CUSTOS
            'custo_prep_entrega': 66664.00, 'laudo_custo': 4689.00,
            # DESPESAS OPERACIONAIS
            'comissao_venda': 30.00, 'despachante_sai': 4045.84, 'comissao_c': 2824.97,
            'desp_adm_dem': 1401.69, 'desp_pessoal_var': 912.68, 'agua': 224.00,
            'contabil': 42591.00, 'juridico': 12962.34, 'emprestimos': 20750.20,
            # RES. FINANCEIRO
            'retorno_comiss': 15223.34, 'rendimento': 80.10, 'desc_pagar': 20953.50,
            'juros_rec': 249.13, 'desc_receber': 56.50, 'juros_pagar': 1174.01,
            'juros_pagar2': 0.00,
        },
        '4': {
            # RECEITAS
            'rec_doc_sai': 7943.32, 'rec_svc': 5630.00, 'laudo_venda': 3410.00,
            # DEDUÇÕES
            'desc_sw': 63868.23, 'desc_at': 4400.00,
            # CUSTOS
            'custo_prep_entrega': 91339.95, 'frete': 950.00, 'laudo_custo': 3007.20,
            'garantia_custo': 7550.00, 'ipva': 30157.90,
            # DESPESAS OPERACIONAIS
            'comissao_venda': 250.00, 'desp_adm_dem': 9097.38, 'agua': 120.00,
            'contabil': 52861.36, 'juridico': 5249.00, 'estacionamento': 100.50,
            'emprestimos': 26087.18,
            # RES. FINANCEIRO
        ...
        '7': {
            # RECEITAS
            'rec_svc': 9710.00, 'venda_svc': 14998.73, 'rec_doc_sai': 30764.70,
            # DEDUÇÕES
            'desc_sw': 52580.11, 'desc_at': 33774.00,
            # CUSTOS
            'custo_prep_entrega': 65128.26, 'frete': 950.00, 'multa_veiculo': 0.00,
            'ipva': 38799.62, 'laudo_custo': 7929.80, 'garantia_custo': 800.00,
            # DESPESAS OPERACIONAIS
        ...
        '8': {
            # RECEITAS
            'rec_doc_sai': 8281.11, 'rec_svc': 2530.00,
            # DEDUÇÕES
            'desc_sw': 26900.01,
            # CUSTOS
            'custo_prep_entrega': 32241.11, 'taxas_transf_ent': 17000.48,
            'ipva': 18156.89, 'laudo_custo': 4361.80,
            # DESPESAS OPERACIONAIS
            'despachante_sai': 462.84, 'emprestimos': 25978.14, 'desp_adm_dem': 474.38,
            'desp_pessoal_var': 65.80, 'estacionamento': 29.70, 'contabil': 56346.71,
            'pub_adm': 28.00, 'juridico': 6249.35,
            # RES. FINANCEIRO
            'retorno_comiss': 26552.02, 'juros_rec': 2194.69, 'desc_pagar': 12555.60,
            'desc_receber': 845.15, 'juros_pagar': 87.69,
        },
        '9': {
            # RECEITAS
            'rec_svc': 8639.00, 'rec_doc_sai': 9517.91,
            # DEDUÇÕES
            'desc_sw': 42915.70, 'desc_at': 17980.00,
            # CUSTOS
            'laudo_custo': 2913.50, 'custo_prep_entrega': 65871.44, 'frete': 130.00,
            'taxas_transf_ent': 13832.58, 'ipva': 26494.56, 'despachante_ent': 5570.00,
            # DESPESAS OPERACIONAIS
            'refeitorio': 703.98, 'despachante_sai': 305.91, 'desp_adm_dem': 9414.85,
            'desp_pessoal_var': 65.80, 'contabil': 54748.21, 'informatica': 250.00,
            'juridico': 6391.00, 'emprestimos': 25265.94,
            # RES. FINANCEIRO
            'retorno_comiss': 42461.18, 'desc_pagar': 16318.95, 'juros_rec': 55.54,
            'juros_pagar': 3137.89, 'desc_receber': 54.19,
        },
        '10': {
            # RECEITAS
            'merch_bruta_sw': 3029090.95, 'rec_svc': 7830.00, 'rec_doc_sai': 13367.12,
            # DEDUÇÕES
            'desc_sw': 84890.00, 'desc_at': 15030.00,
            # CUSTOS
            'custo_prep_entrega': 87799.53, 'taxas_transf_ent': 14657.80,
            'ipva': 31784.54, 'despachante_ent': 5100.00, 'laudo_custo': 3274.50,
            # DESPESAS OPERACIONAIS
            'despachante_sai': 61.90, 'desp_adm_dem': 35.17, 'desp_pessoal_var': 2922.19,
            'agua': 54.00, 'contabil': 48937.53, 'juridico': 6299.00,
            'emprestimos': 25007.38,
            # RES. FINANCEIRO
            'desc_pagar': 16992.03, 'juros_rec': 0.01, 'juros_pagar': 2980.78,
            'desc_receber': 1533.91,
        },
        '11': {
            # RECEITAS
            'rec_svc': 3820.00, 'rec_doc_sai': 25869.47, 'laudo_venda': 3854.90,
            # DEDUÇÕES
            'desc_sw': 82421.30, 'desc_at': 23740.01,
            # CUSTOS
            'custo_prep_entrega': 58326.92, 'despachante_ent': 3720.00,
            'ipva': 17730.91, 'taxas_transf_ent': 16541.00, 'laudo_custo': 4156.10,
            # DESPESAS OPERACIONAIS
            'despachante_sai': 61.90, 'desp_pessoal_var': 2461.80, 'contabil': 419784.32,
            'juridico': 8199.00, 'emprestimos': 28754.68,
            # RES. FINANCEIRO
            'retorno_comiss': 78307.11, 'juros_rec': 4.61, 'desc_pagar': 5186.93,
            'juros_pagar': 597.76, 'desc_receber': 1344.64,
        },
        '12': {
            # RECEITAS
            'rec_svc': 6806.00, 'rec_doc_sai': 6681.73,
            # DEDUÇÕES
            'desc_at': 60673.84,
            # CUSTOS
            'taxas_transf_ent': 16862.58, 'despachante_ent': 6290.00,
            'laudo_custo': 4549.80, 'garantia_custo': 8800.00,
            'custo_prep_entrega': 35301.28, 'frete': 0.00, 'ipva': 3276.07,
            # DESPESAS OPERACIONAIS
            'despachante_sai': 61.90, 'salarios': 143286.26, 'desp_adm_dem': 6342.75,
            'contabil': 38698.53, 'juridico': 6408.80, 'emprestimos': 28391.81,
            # RES. FINANCEIRO
            'retorno_comiss': 46030.70, 'retorno_acordos': 0.00, 'tarifa_bancaria': 266.86,
            'juros_pagar': 2073.51, 'desc_pagar': 14419.41, 'desc_receber': 52.06,
        },
    },
    'bk':   {
        '1': {
        ...
        '2': {
            # RECEITAS/CUSTOS
            'venda_svc': 910.00, 'custo_prep_entrega': 191.00, 'frete': 0.00,
            'ipva': 3212.10, 'laudo_custo': 800.00,
            # DESPESAS OPERACIONAIS
            'comissao_venda': 50.00, 'agua': 59.73, 'contabil': 190.91,
            'desp_adm_dem': 0.00, 'desp_pessoal_var': 0.00, 'juridico': 0.00,
            'emprestimos': 0.00,
            # RES. FINANCEIRO
            'retorno_comiss': 6289.79, 'desc_pagar': 0.00, 'juros_rec': 291.18,
            'desc_receber': 0.00, 'juros_pagar2': 0.00,
        },
        '3': {
            # RECEITAS/CUSTOS
            ...
            # RES. FINANCEIRO
            'retorno_comiss': 848.85, 'rendimento': 4.84, 'desc_pagar': 0.01,
            'juros_rec': 0.00, 'desc_receber': 0.00, 'juros_pagar': 19.91,
            'juros_pagar2': 0.00,
        },
        '5': {
            # RECEITAS/CUSTOS
            'rec_doc_sai': 10013.72, 'laudo_venda': 3250.00, 'rec_svc': 0.00,
            'custo_compra_sw': 1104470.00,
            'custo_prep_entrega': 3238.00, 'frete': 0.00,
            # DEDUÇÕES
            'desc_sw': 4900.00,
            # DESPESAS OPERACIONAIS
            'desp_adm_dem': 700.00, 'contabil': 2589.93, 'agua': 259.52,
            # RES. FINANCEIRO
        ...
        '6': {
            # RECEITAS/CUSTOS
            'rec_svc': 700.00, 'rec_doc_sai': 256.25, 'custo_prep_entrega': 1616.44,
            # DESPESAS OPERACIONAIS
            'contabil': 4116.08, 'agua': 120.80, 'juridico': 1400.00,
            # RES. FINANCEIRO
            'desc_pagar': 193.35, 'desc_receber': 659.91, 'juros_pagar': 32.33,
        },
        '7': {
            # RECEITAS/CUSTOS
            'rec_doc_sai': 1301.26, 'rec_svc': 0.00, 'custo_prep_entrega': 3997.50,
            # DESPESAS OPERACIONAIS
            'comissao_venda': 119.79, 'contabil': 15527.32, 'juridico': 1000.00,
            'agua': 87.65,
            # RES. FINANCEIRO
            'desc_pagar': 4070.96, 'juros_pagar': 243.26,
        },
        '8': {
            # RECEITAS/CUSTOS
            'rec_doc_sai': 2873.88, 'custo_prep_entrega': 188.70,
            # DESPESAS OPERACIONAIS
        ...
        '9': {
            # RECEITAS/CUSTOS
            'rec_doc_sai': 2789.61, 'rec_svc': 800.00,
            'custo_prep_entrega': 4666.79, 'frete': 90.33, 'laudo_custo': 1094.70,
            # DESPESAS OPERACIONAIS
            'contabil': 5711.21, 'juridico': 2800.00, 'agua': 178.48,
            # RES. FINANCEIRO
            'retorno_comiss': 1766.85, 'desc_pagar': 906.53, 'juros_rec': 121.63,
        },
        '10': {
            # RECEITAS/CUSTOS
            'rec_doc_sai': 134.00, 'rec_svc': 1000.00,
            'custo_prep_entrega': 13224.83, 'frete': 0.00, 'laudo_custo': 179.90,
            # DESPESAS OPERACIONAIS
            'desp_pessoal_var': 522.08, 'contabil': 10698.05, 'juridico': 2600.00,
            'agua': 190.34,
            # RES. FINANCEIRO
        ...
        '12': {
            ...
            'desc_at': 25050.00,
            # CUSTOS
            'taxas_transf_ent': 2206.00, 'custo_prep_entrega': 7772.42, 'laudo_custo': 360.00,
            # DESPESAS OPERACIONAIS
            'agua': 761.07, 'contabil': 2363.93, 'juridico': 65.80,
            'desp_pessoal_var': 347.00,
            # RES. FINANCEIRO
            'retorno_comiss': 1474.33, 'juros_rec': 13.60,
            'desc_pagar': 328.90, 'juros_pagar': 10.00,
        },
    },
    'cons': {
        '1': {
